...
SWIFT_CLASS("_TtC11appointment12CalenderView")
@interface CalenderView : UIView <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
...
SWIFT_CLASS("_TtC11appointment9MonthView")
@interface MonthView : UIView
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (void)btnLeftRightActionWithSender:(UIButton * _Nonnull)sender;
...
SWIFT_CLASS("_TtC11appointment8TimeCell")
...
@interface TimeCell (SWIFT_EXTENSION(appointment)) <UITableViewDataSource, UITableViewDelegate>
...
SWIFT_CLASS("_TtC11appointment14ViewController")
@interface ViewController : UIViewController <FSCalendarDelegate>
...
@interface ViewController (SWIFT_EXTENSION(appointment)) <UICollectionViewDataSource, UICollectionViewDelegate>
...
SWIFT_CLASS("_TtC11appointment12WeekdaysView")
@interface WeekdaysView : UIView
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC11appointment10dateCVCell")
@interface dateCVCell : UICollectionViewCell
